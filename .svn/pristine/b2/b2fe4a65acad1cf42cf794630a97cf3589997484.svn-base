package com.wanding.xingpos.getui;
...
import com.wanding.xingpos.activity.PrintTextActivity;
import com.wanding.xingpos.activity.ScanPayActivity;
import com.wanding.xingpos.activity.TestLayout;
...
public class DemoIntentService extends GTIntentService {
    ...
    public void onReceiveMessageData(Context context, GTTransmitMessage msg) {
        ...
        if (payload == null) {
            ...
            intent.setClass(context,PrintTextActivity.class);
    ...
    public void onReceiveClientId(Context context, String clientid) {
        ...
        //保存cid
        sharedPreferencesUtil = new SharedPreferencesUtil(context,"clientid");
        sharedPreferencesUtil.put("cid",clientid);
