...
public class FuyouPrintUtil {
	...
	public static String getPayWay(String payType){
		if("040".equals(payType)||"0".equals(payType)){
			return "BANK";
		}else if("010".equals(payType)||"11".equals(payType)){
			return "WX";
		}else if("020".equals(payType)||"12".equals(payType)){
			return "ALI";
		}else if("030".equals(payType)||"13".equals(payType)){
			return "UNIONPAY";
		}else if("050".equals(payType)){
			return "BEST";
		}else if("060".equals(payType)||"13".equals(payType)){
			return "UNIONPAY";
		}
		return "";
	}
	...
	private static String getPayTypeStr(String payType){
		if("000".equals(payType)){
			return "现金支付/CASH PAY";
		}else if("040".equals(payType)){
			...
			return "扫码预授权/PAY";
		}else if("800".equals(payType)){
			return "会员卡支付/MEMBER PAY";
		}
		return "";
	}
     ...
     *  支付成功打印(包括重打印)
     */
    public static String paySuccessPrintText(Context context, PosScanpayResData payResData, UserLoginResData posPublicData,
											 boolean isDefault,final String printRemarks,final int index){
		...
		try {
			...
			//添加优惠券信息
			String url = payResData.getUrl();
			if(Utils.isNotEmpty(url)){
				jsonArray.put(PrintUtils.setStringContent("微信扫一扫领优惠", 2, 3));
				jsonArray.put(PrintUtils.setStringContent("-------------------------------", 1, 2));// 打印虚线
				jsonArray.put(PrintUtils.setTwoDimension(url,2,3));//二维码内容
				jsonArray.put(PrintUtils.setStringContent("-------------------------------", 1, 2));// 打印虚线
			}
     ...
     *  支付成功重打印
     */
	public static void paySuccessAgainPrintText(Context context, PrintInterface printService,PosScanpayResData payResData,
	...
	public static String authPaySuccessPrintText(Context context, PrintInterface printService,PreLicensingResp payResData,
		...
		try {
			...
			jsonArray.put(PrintUtils.setStringContent("终端编号："+posPublicData.getTrmNo_pos(), 1, 2));
			if(isDefault){
				jsonArray.put(PrintUtils.setStringContent("交易类型："+getAuthPayTypeStr(payResData.getAuth_type()), 1, 2));
			}else{
				jsonArray.put(PrintUtils.setStringContent("交易类型：", 1, 2));
				jsonArray.put(PrintUtils.setStringContent(getAuthPayTypeStr(payResData.getAuth_type()), 1, 3));
			}
    ...
    public static void cardPaySuccessPrintText(Context context,PrintInterface printService,CardPaymentDate cardPayResData,
		...
		try {
			...
			jsonArray.put(PrintUtils.setStringContent("          ", 2, 1));
			//添加优惠券信息
			String url = cardPayResData.getUrl();
			if(Utils.isNotEmpty(url)){
				jsonArray.put(PrintUtils.setStringContent("微信扫一扫领优惠", 2, 3));
				jsonArray.put(PrintUtils.setStringContent("-------------------------------", 1, 2));// 打印虚线
				jsonArray.put(PrintUtils.setTwoDimension(url,2,3));//二维码内容
	 ...
	 *  核销成功打印小票
	 */
	public static void writeOffPrintText(Context context, PrintInterface printService, WriteOffResData writeOffResData, UserLoginResData posPublicData,String isMakeUp){
		getPrinterStatus(context,printService);
		JSONObject jsonObject = new JSONObject();
		JSONArray jsonArray = new JSONArray();
		//打印文字
		try {
			...
			jsonArray.put(PrintUtils.setStringContent("-------------------------------", 1, 2));// 打印虚线
			jsonArray.put(PrintUtils.setStringContent("商户名称："+posPublicData.getMername_pos(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("卡劵名称："+writeOffResData.getTitle(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("核销劵码："+writeOffResData.getCode(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("核销状态：使用成功", 1, 2));
			jsonArray.put(PrintUtils.setStringContent("使用时间："+DateTimeUtil.stampToDate(Long.parseLong(writeOffResData.getCreateTime())), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("POS设备号："+posPublicData.getTrmNo_pos(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("备注：", 1, 2));
	 ...
	 *  核销记录详情打印小票
	 */
	public static void writeOffDetailPrintText(Context context, PrintInterface printService, WriteOffRecodeDetailResData writeOffRecode, UserLoginResData posPublicData){
		getPrinterStatus(context,printService);
		JSONObject jsonObject = new JSONObject();
		JSONArray jsonArray = new JSONArray();
		//打印文字
		try {
			...
			jsonArray.put(PrintUtils.setStringContent("-------------------------------", 1, 2));// 打印虚线
			jsonArray.put(PrintUtils.setStringContent("商户名称："+posPublicData.getMername_pos(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("卡劵名称："+writeOffRecode.getTitle(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("核销劵码："+writeOffRecode.getCode(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("核销状态：使用成功", 1, 2));
			jsonArray.put(PrintUtils.setStringContent("使用时间："+DateTimeUtil.stampToDate(writeOffRecode.getUse_time()), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("POS设备号："+posPublicData.getTrmNo_pos(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("备注：", 1, 2));
			jsonArray.put(PrintUtils.setStringContent("-------------------------------", 1, 2));// 打印虚线
	 ...
	 *  计次卡核销记录详情打印小票
	 */
	public static String numCardDetailPrintText(NumCardRecodeDetail order, UserLoginResData posPublicData){
		...
		try {
			...
			jsonArray.put(PrintUtils.setStringContent("-------------------------------", 1, 2));// 打印虚线
			jsonArray.put(PrintUtils.setStringContent("商户名称："+posPublicData.getMername_pos(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("卡劵名称："+order.getCard_name(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("核销劵码："+order.getCode(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("核销状态：使用成功", 1, 2));
			jsonArray.put(PrintUtils.setStringContent("使用时间："+DateTimeUtil.stampToDate(order.getUse_time()), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("POS设备号："+posPublicData.getTrmNo_pos(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("备注：", 1, 2));
			jsonArray.put(PrintUtils.setStringContent("-------------------------------", 1, 2));// 打印虚线
	 ...
	 *  优惠券核销记录详情打印小票
	 */
	public static String couponsDetailPrintText(CouponsRecodeDetail order, UserLoginResData posPublicData){
		...
		try {
			...
			jsonArray.put(PrintUtils.setStringContent("-------------------------------", 1, 2));// 打印虚线
			jsonArray.put(PrintUtils.setStringContent("商户名称："+posPublicData.getMername_pos(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("卡劵名称："+order.getTitle(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("核销劵码："+order.getCode(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("核销状态：使用成功", 1, 2));
			jsonArray.put(PrintUtils.setStringContent("使用时间："+DateTimeUtil.stampToDate(order.getUse_time()), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("POS设备号："+posPublicData.getTrmNo_pos(), 1, 2));
	 ...
	 *  批量制劵---->> 小票
	 */
	public static String batchSecurPrintText(Context context,List<String> list,UserLoginResData posPublicData,SecurDetailData securDetailData){
		...
		try {
			for (int i = 0;i<list.size();i++){
				...
				if(securDetailData!=null){
					jsonArray.put(PrintUtils.setStringContent(securDetailData.getTitle(), 2, 3));//劵名称
				}
...
//				jsonArray.put(PrintUtils.setStringContent(list.get(i), 2, 3));//二维码内容
	 ...
	 *  优惠券领券二维码小票
	 */
	public static void cardStockPrintText(Context context,PrintInterface printService,String url){
		getPrinterStatus(context,printService);
		JSONObject jsonObject = new JSONObject();
		JSONArray jsonArray = new JSONArray();
		//打印文字
	 ...
	 * 充值成功打印小票
	 */
	public static String depositSuccessPrintText(Context context,PosDepositResData payResData,
										   UserLoginResData posPublicData, boolean isDefault,final String printRemarks,final int index){
		JSONObject jsonObject = new JSONObject();
		JSONArray jsonArray = new JSONArray();
		//打印文字
		try {
			...
			jsonArray.put(PrintUtils.setStringContent("商户名称："+posPublicData.getMername_pos(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("终端编号："+posPublicData.getTrmNo_pos(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("业务类型：会员充值", 1, 2));
			jsonArray.put(PrintUtils.setStringContent("会员卡号："+payResData.getMemberCode(), 1, 2));
			if(isDefault){
				jsonArray.put(PrintUtils.setStringContent("交易类型："+getPayTypeStr(payResData.getPay_type()), 1, 2));
			}else{
				jsonArray.put(PrintUtils.setStringContent("交易类型：", 1, 2));
			...
			//添加优惠券信息
			String url = payResData.getReceiveTicketUrl();
			if(Utils.isNotEmpty(url)){
				jsonArray.put(PrintUtils.setStringContent("微信扫一扫领优惠", 2, 3));
				jsonArray.put(PrintUtils.setStringContent("-------------------------------", 1, 2));// 打印虚线
				jsonArray.put(PrintUtils.setTwoDimension(url,2,3));//二维码内容
	 ...
	 * 充值记录补打小票
	 */
	public static String depositRecodeDetailPrintText(Context context,DepositOrder order,
												 UserLoginResData posPublicData, boolean isDefault,final int index){
		JSONObject jsonObject = new JSONObject();
		JSONArray jsonArray = new JSONArray();
		//打印文字
		try {
			...
			jsonArray.put(PrintUtils.setStringContent("终端编号："+posPublicData.getTrmNo_pos(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("业务类型：会员充值", 1, 2));
			jsonArray.put(PrintUtils.setStringContent("会员卡号："+order.getCard_barcode(), 1, 2));
			if(isDefault){
				jsonArray.put(PrintUtils.setStringContent("交易类型："+getQueryPayTypeStr(order.getPay_way()), 1, 2));
			}else{
				jsonArray.put(PrintUtils.setStringContent("交易类型：", 1, 2));
				jsonArray.put(PrintUtils.setStringContent(getPayTypeStr(order.getPay_way()), 1, 3));
			}
			String outTradeNoStr = order.getOrder_id();
			String outTradeNo = "";
			String outTradeNoSuffix = "";
			if(Utils.isNotEmpty(outTradeNoStr)&&outTradeNoStr.length()>=32){
				outTradeNo = outTradeNoStr.substring(0,24);
			...
			jsonArray.put(PrintUtils.setStringContent("日期/时间："+DateTimeUtil.stampToDate(Long.parseLong(order.getPay_time())), 1, 2));
			if(isDefault){
				jsonArray.put(PrintUtils.setStringContent("金额：RMB "+DecimalUtil.StringToPrice(order.getAmount()), 1, 2));
			}else{
				jsonArray.put(PrintUtils.setStringContent("金额：", 1, 2));
				jsonArray.put(PrintUtils.setStringContent("RMB "+DecimalUtil.StringToPrice(order.getAmount()), 1, 3));
			}
//			jsonArray.put(PrintUtils.setStringContent("余额：RMB "+DecimalUtil.StringToPrice(order.getAccountBalance()), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("备注：", 1, 2));
			if(index == 1){
				jsonArray.put(PrintUtils.setStringContent("持卡人签名：", 1, 2));
				jsonArray.put(PrintUtils.setStringContent("          ", 2, 1));
	...
	/**
	 * 会员消费成功打印小票(线上付费购卡打印小票)
	 */
	public static String memConsumePrintText(Context context, PosMemConsumeRespData payResData, UserLoginResData posPublicData,
											 boolean isDefault, String printRemarks,final int index){
		JSONObject jsonObject = new JSONObject();
		JSONArray jsonArray = new JSONArray();
		//打印文字
		try {
			...
			//会员卡号
			String memberCode = payResData.getMemberCode();
			if(Utils.isNotEmpty(memberCode)){
				jsonArray.put(PrintUtils.setStringContent("业务类型：会员消费", 1, 2));
				jsonArray.put(PrintUtils.setStringContent("会员卡号："+payResData.getMemberCode(), 1, 2));
			}else{
				jsonArray.put(PrintUtils.setStringContent("业务类型：线上付费购卡", 1, 2));
			}
			if(isDefault){
				jsonArray.put(PrintUtils.setStringContent("交易类型："+getPayTypeStr(payResData.getPay_type()), 1, 2));
			}else{
	 ...
	 * 会员消费记录补打小票
	 */
	public static String memPayRecodeDetailPrintText(Context context,PosMemConsumeRecodeDetail payResData,UserLoginResData posPublicData,
											 boolean isDefault,final String printRemarks,final int index){
		JSONObject jsonObject = new JSONObject();
		JSONArray jsonArray = new JSONArray();
		//打印文字
		try {
			...
			jsonArray.put(PrintUtils.setStringContent("终端编号："+posPublicData.getTrmNo_pos(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("业务类型：会员消费", 1, 2));
			jsonArray.put(PrintUtils.setStringContent("会员卡号："+payResData.getMemCode(), 1, 2));
			if(isDefault){
				jsonArray.put(PrintUtils.setStringContent("交易类型："+getQueryPayTypeStr(payResData.getPayWay()), 1, 2));
			}else{
				jsonArray.put(PrintUtils.setStringContent("交易类型：", 1, 2));
				jsonArray.put(PrintUtils.setStringContent(getQueryPayTypeStr(payResData.getPayWay()), 1, 3));
			}
			String outTradeNoStr = payResData.getOrderId();
			String outTradeNo = "";
			String outTradeNoSuffix = "";
			if(Utils.isNotEmpty(outTradeNoStr)&&outTradeNoStr.length()>=32){
				outTradeNo = outTradeNoStr.substring(0,24);
			...
			jsonArray.put(PrintUtils.setStringContent("日期/时间："+payResData.getCreateTime(), 1, 2));
			if(isDefault){
				jsonArray.put(PrintUtils.setStringContent("金额：RMB "+DecimalUtil.StringToPrice(payResData.getTotalFee()), 1, 2));
			}else{
				jsonArray.put(PrintUtils.setStringContent("金额：", 1, 2));
				jsonArray.put(PrintUtils.setStringContent("RMB "+DecimalUtil.StringToPrice(payResData.getTotalFee()), 1, 3));
			}
			jsonArray.put(PrintUtils.setStringContent("备注：", 1, 2));
			if(index == 1){
				jsonArray.put(PrintUtils.setStringContent("持卡人签名：", 1, 2));
			...
			//添加优惠券信息
			String url = payResData.getImgUrl();
			if(Utils.isNotEmpty(url)){
				jsonArray.put(PrintUtils.setStringContent("微信扫一扫领优惠", 2, 3));
				jsonArray.put(PrintUtils.setStringContent("-------------------------------", 1, 2));// 打印虚线
				jsonArray.put(PrintUtils.setTwoDimension(url,2,3));//二维码内容
	 ...
	 * 透传消息打印小票
	 */
	public static String pussPrintText(String data_sourceStr, PosPrintTemplate order,UserLoginResData posPublicData,
									   boolean isDefault, final String printRemarks, final int index){
		JSONObject jsonObject = new JSONObject();
		JSONArray jsonArray = new JSONArray();
		//打印文字
		try {
			...
			jsonArray.put(PrintUtils.setStringContent("商户名称："+posPublicData.getMername_pos(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("终端编号："+posPublicData.getTrmNo_pos(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("业务类型："+data_sourceStr, 1, 2));
            if(isDefault){
                jsonArray.put(PrintUtils.setStringContent("交易类型："+getQueryPayTypeStr(order.getTradeType()), 1, 2));
            }else{
                jsonArray.put(PrintUtils.setStringContent("交易类型：", 1, 2));
                jsonArray.put(PrintUtils.setStringContent(getQueryPayTypeStr(order.getTradeType()), 1, 3));
            }
            if(data_sourceStr.equals("在线预订")){
				jsonArray.put(PrintUtils.setStringContent("适用房型："+ order.getRoomType(), 1, 2));
				jsonArray.put(PrintUtils.setStringContent("适用场次："+order.getTimeLimite(), 1, 2));
			}
			...
			jsonArray.put(PrintUtils.setStringContent("日期/时间："+order.getTransTime(), 1, 2));
			if(isDefault){
				jsonArray.put(PrintUtils.setStringContent("金额：RMB "+DecimalUtil.StringToPrice(order.getTransAmount()), 1, 2));
			}else{
				jsonArray.put(PrintUtils.setStringContent("金额：", 1, 2));
				jsonArray.put(PrintUtils.setStringContent("RMB "+DecimalUtil.StringToPrice(order.getTransAmount()), 1, 3));
			}
			jsonArray.put(PrintUtils.setStringContent("备注：", 1, 2));
			if(index == 1){
				jsonArray.put(PrintUtils.setStringContent("持卡人签名：", 1, 2));
	 ...
	 */
	public static String authPrintText(UserLoginResData posPublicData, AuthResultResponse resData,String authAction,boolean isDefault, final String printRemarks, final int index){
		...
		try {
			...
			jsonArray.put(PrintUtils.setStringContent("终端编号："+posPublicData.getTrmNo_pos(), 1, 2));
			if(isDefault){
				jsonArray.put(PrintUtils.setStringContent("交易类型："+getAuthPayTypeStr(authAction), 1, 2));
			}else{
				jsonArray.put(PrintUtils.setStringContent("交易类型：", 1, 2));
				jsonArray.put(PrintUtils.setStringContent(getAuthPayTypeStr(authAction), 1, 3));
			}
			if(authAction.equals(Constants.AUTH_CONFIRM_CANCEL_ACTION)){
				...
				jsonArray.put(PrintUtils.setStringContent("订 单 号：", 1, 2));
				jsonArray.put(PrintUtils.setStringContent(refundNo, 1, 2));
				String tradeNoStr = resData.getOut_trade_no();
				String tradeNo = "";
				if(Utils.isNotEmpty(tradeNoStr)){
					tradeNo = tradeNoStr;
				}
				jsonArray.put(PrintUtils.setStringContent("原订单号：", 1, 2));
				jsonArray.put(PrintUtils.setStringContent(tradeNo, 1, 2));
			}else{
				jsonArray.put(PrintUtils.setStringContent("订 单 号：", 1, 2));
				jsonArray.put(PrintUtils.setStringContent(resData.getOut_trade_no(), 1, 2));
			}
			...
			jsonArray.put(PrintUtils.setStringContent("渠道单号：", 1, 2));
			jsonArray.put(PrintUtils.setStringContent(channerTradeNo, 1, 2));
			if(authAction.equals(Constants.AUTH_ACTION)||authAction.equals(Constants.AUTH_CANCEL_ACTION)){
				if(isDefault){
					...
					jsonArray.put(PrintUtils.setStringContent("金额：RMB "+totalFee, 1, 2));
					...
					jsonArray.put(PrintUtils.setStringContent("金额：", 1, 2));
					jsonArray.put(PrintUtils.setStringContent("RMB "+totalFee, 1, 3));
				}
			}else if(authAction.equals(Constants.AUTH_CONFIRM_ACTION)){
				if(isDefault){
					jsonArray.put(PrintUtils.setStringContent("金额：RMB "+DecimalUtil.branchToElement(resData.getConsume_fee()), 1, 2));
				}else{
					jsonArray.put(PrintUtils.setStringContent("金额：", 1, 2));
					jsonArray.put(PrintUtils.setStringContent("RMB "+DecimalUtil.branchToElement(resData.getConsume_fee()), 1, 3));
				}
			}else if(authAction.equals(Constants.AUTH_CONFIRM_CANCEL_ACTION)){
				if(isDefault){
					jsonArray.put(PrintUtils.setStringContent("金额：RMB "+DecimalUtil.branchToElement(resData.getRefund_fee()), 1, 2));
				}else{
					jsonArray.put(PrintUtils.setStringContent("金额：", 1, 2));
					jsonArray.put(PrintUtils.setStringContent("RMB "+DecimalUtil.branchToElement(resData.getRefund_fee()), 1, 3));
				}
			}
			jsonArray.put(PrintUtils.setStringContent("日期/时间："+resData.getEnd_time(), 1, 2));
			jsonArray.put(PrintUtils.setStringContent("备注：", 1, 2));
			if(index == 1){
				jsonArray.put(PrintUtils.setStringContent("持卡人签名：", 1, 2));
				jsonArray.put(PrintUtils.setStringContent("          ", 2, 1));
			...
			if(Constants.AUTH_ACTION.equals(authAction)){
				jsonArray.put(PrintUtils.setStringContent("          ", 2, 1));
				jsonArray.put(PrintUtils.setStringContent("-------------------------------", 1, 2));// 打印虚线
				jsonArray.put(PrintUtils.setTwoDimension(resData.getOut_trade_no(),2,3));
				jsonArray.put(PrintUtils.setStringContent("预授权完成/撤销请使用POS机扫描二维码!", 1, 2));
			}
			jsonArray.put(PrintUtils.setStringContent("-------------------------------", 1, 2));// 打印虚线
			if(isDefault){
	 ...
	 *  1,扫码预授权,2,预授权撤销，3，预授权完成，4，预授权完成撤销
	 */
	public static String authRecodeDetailPrintText(UserLoginResData posPublicData, WdPreAuthHistoryVO resData, boolean isDefault, final String printRemarks, final int index){
		...
		try {
			...
			if(isDefault){
				jsonArray.put(PrintUtils.setStringContent("交易类型："+getAuthPayTypeStr(payAuthStatus), 1, 2));
			}else{
				jsonArray.put(PrintUtils.setStringContent("交易类型：", 1, 2));
				jsonArray.put(PrintUtils.setStringContent(getAuthPayTypeStr(payAuthStatus), 1, 3));
			}
			jsonArray.put(PrintUtils.setStringContent("订 单 号：", 1, 2));
			jsonArray.put(PrintUtils.setStringContent(resData.getMchntOrderNo(), 1, 2));
			...
			if(Constants.AUTH_ACTION.equals(payAuthStatus)){
				jsonArray.put(PrintUtils.setStringContent("押金金额：RMB "+DecimalUtil.StringToPrice(resData.getOrderAmt()), 1, 2));
				Long payTimeStr = resData.getPreTime();
				if(payTimeStr !=null){
					payTime = DateTimeUtil.stampToFormatDate(payTimeStr, "yyyy-MM-dd HH:mm:ss");
				}
				jsonArray.put(PrintUtils.setStringContent("日期/时间："+payTime, 1, 2));
				...
				jsonArray.put(PrintUtils.setStringContent("押金金额：RMB "+DecimalUtil.StringToPrice(resData.getOrderAmt()), 1, 2));
				jsonArray.put(PrintUtils.setStringContent("消费金额：RMB "+DecimalUtil.StringToPrice(resData.getConsumeFee()), 1, 2));
				Long payTimeStr = resData.getTxnEndTs();
				if(payTimeStr !=null){
					payTime = DateTimeUtil.stampToFormatDate(payTimeStr, "yyyy-MM-dd HH:mm:ss");
				}
				...
				jsonArray.put(PrintUtils.setStringContent("原订单号：", 1, 2));
				jsonArray.put(PrintUtils.setStringContent(resData.getOrgOrderNo(), 1, 2));
				jsonArray.put(PrintUtils.setStringContent("押金金额：RMB "+DecimalUtil.StringToPrice(resData.getOrderAmt()), 1, 2));
				jsonArray.put(PrintUtils.setStringContent("消费金额：RMB "+DecimalUtil.StringToPrice(resData.getConsumeFee()), 1, 2));
				jsonArray.put(PrintUtils.setStringContent("退款金额：RMB "+DecimalUtil.StringToPrice(resData.getRefundFee()), 1, 2));
				Long payTimeStr = resData.getTxnEndTs();
				if(payTimeStr !=null){
					payTime = DateTimeUtil.stampToFormatDate(payTimeStr, "yyyy-MM-dd HH:mm:ss");
				}
			...
			jsonArray.put(PrintUtils.setStringContent("备注：交易明细", 1, 2));
			if(index == 1){
				jsonArray.put(PrintUtils.setStringContent("持卡人签名：", 1, 2));
				jsonArray.put(PrintUtils.setStringContent("          ", 2, 1));
				jsonArray.put(PrintUtils.setStringContent("交易金额不足300.00元，无需签名", 2, 2));
			...
			if(Constants.AUTH_ACTION.equals(payAuthStatus)){
				jsonArray.put(PrintUtils.setStringContent("          ", 2, 1));
				jsonArray.put(PrintUtils.setStringContent("-------------------------------", 1, 2));// 打印虚线
				jsonArray.put(PrintUtils.setTwoDimension(resData.getMchntOrderNo(),2,3));
				jsonArray.put(PrintUtils.setStringContent("预授权完成/撤销请使用POS机扫描二维码!", 1, 2));
			}
			jsonArray.put(PrintUtils.setStringContent("-------------------------------", 1, 2));// 打印虚线
			if(isDefault){
	 ...
	 * 线上付费购卡记录详情打印小票
	 */
	public static String buyCardRecodeDetailPrintText(BuyCardRecodeDetail recodeDetail, UserLoginResData posPublicData,
													  boolean isDefault, String printRemarks, final int index){
		JSONObject jsonObject = new JSONObject();
		JSONArray jsonArray = new JSONArray();
		//打印文字
		try {
			...
			if(isDefault){
				jsonArray.put(PrintUtils.setStringContent("交易类型："+getQueryPayTypeStr(recodeDetail.getPayWay()), 1, 2));
			}else{
				jsonArray.put(PrintUtils.setStringContent("交易类型：", 1, 2));
				jsonArray.put(PrintUtils.setStringContent(getQueryPayTypeStr(recodeDetail.getPayWay()), 1, 3));
			}


			String outTradeNoStr = recodeDetail.getOrderId();
			String outTradeNo = "";
			String outTradeNoSuffix = "";
			if(Utils.isNotEmpty(outTradeNoStr)&&outTradeNoStr.length()>=32){
				outTradeNo = outTradeNoStr.substring(0,24);
			...
			jsonArray.put(PrintUtils.setStringContent("日期/时间："+recodeDetail.getCreateTime(), 1, 2));
			if(isDefault){
				jsonArray.put(PrintUtils.setStringContent("金额：RMB "+DecimalUtil.StringToPrice(recodeDetail.getTotalFee()), 1, 2));
			}else{
				jsonArray.put(PrintUtils.setStringContent("金额：", 1, 2));
				jsonArray.put(PrintUtils.setStringContent("RMB "+DecimalUtil.StringToPrice(recodeDetail.getTotalFee()), 1, 3));
			}
			jsonArray.put(PrintUtils.setStringContent("备注：", 1, 2));
			if(index == 1){
				jsonArray.put(PrintUtils.setStringContent("持卡人签名：", 1, 2));
			...
			//添加优惠券信息
			String url = recodeDetail.getCodeUrl();
			if(Utils.isNotEmpty(url)){
				jsonArray.put(PrintUtils.setStringContent("微信扫一扫领优惠", 2, 3));
				jsonArray.put(PrintUtils.setStringContent("-------------------------------", 1, 2));// 打印虚线
				jsonArray.put(PrintUtils.setTwoDimension(url,2,3));//二维码内容
