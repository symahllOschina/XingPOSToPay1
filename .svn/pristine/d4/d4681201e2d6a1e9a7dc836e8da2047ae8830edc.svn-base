 ...
 * 会员消费记录
 */
@ContentView(R.layout.member_pay_recode_list)
public class MemberPayRecodeListActivity extends BaseActivity implements View.OnClickListener,XListView.IXListViewListener,AdapterView.OnItemClickListener {
    ...
    @ViewInject(R.id.member_pay_recode_xListView)
     ...
     */
    String etSearchStr = "";
    private List<PosMemConsumeRecodeDetail> list = new ArrayList<PosMemConsumeRecodeDetail>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        initListener();
        mAdapter = new MemPayRecodeListAdapter(activity,list);
    ...
    private void getRecodeList(final int pageNum,final int pageCount){
        ...
        //参数实体
        final PosMemConsumeRecodeReqData posBean = PayRequestUtil.memPayRecodeQueryReq(pageNum,etSearchStr,startTimeStr,endTimeStr,loginInitData,posProvider);
        ...
        try {
            ...
            if("000000".equals(code)){
                ...
                if("000000".equals(subCode)){
                    ...
                    java.lang.reflect.Type type = new TypeToken<PosMemConsumeRecodeResData>() {}.getType();
                    PosMemConsumeRecodeResData recodeResData = gjson.fromJson(dataJson, type);
                    //获取总条数
                    orderListTotalCount = recodeResData.getTotal();
                    Log.e("总条数：", orderListTotalCount+"");
                    List<PosMemConsumeRecodeDetail> recodeList = new ArrayList<PosMemConsumeRecodeDetail>();
                    //获取的list
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        PosMemConsumeRecodeDetail order = list.get(position - 1);
        Intent intent = new Intent();
        intent.setClass(activity,MemberPayRecodeDetailActivity.class);
