...
public class WriteOffRecodeListAdapter extends BaseAdapter {

    private Context context;
    private List<WriteOffRecodeDetailResData> list;
    private LayoutInflater inflater;

    public WriteOffRecodeListAdapter(Context context, List<WriteOffRecodeDetailResData> list) {
