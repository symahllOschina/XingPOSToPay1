 ...
 * 会员充值记录详情界面
 */
@ContentView(R.layout.activity_buy_card_recode_details)
public class BuyCardRecodeDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    /**
     * 订单号，金额，创建时间，支付时间，支付方式
     */
    @ViewInject(R.id.buy_card_recode_details_tvOrderId)
    TextView tvOrderId;
    @ViewInject(R.id.buy_card_recode_details_tvTotal)
    TextView tvTotal;
    @ViewInject(R.id.buy_card_recode_details_tvCreateTime)
    TextView tvCreateTime;
    @ViewInject(R.id.buy_card_recode_details_tvPayTime)
    TextView tvPayTime;
    @ViewInject(R.id.buy_card_recode_details_tvPayWay)
    TextView tvPayWay;
    @ViewInject(R.id.buy_card_recode_details_tvOrderState)
    TextView tvOrderState;

    @ViewInject(R.id.buy_card_recode_details_btOk)
    Button tvOk;
    @ViewInject(R.id.buy_card_recode_details_btPrint)
    Button tvPrint;
    ...
    private BuyCardRecodeDetail order;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        order = (BuyCardRecodeDetail) intent.getSerializableExtra("order");
...
//        getRecodeDetails();
    ...
    private void getRecodeDetails(){
        ...
        final String url = order.getCodeUrl();
        new Thread(){
            @Override
            public void run() {
...
//            intentToActivity(totalStr);
            ...
            //打印一次
            String printTextStr = FuyouPrintUtil.buyCardRecodeDetailPrintText( order,loginInitData,isDefault,FuyouPrintUtil.payPrintRemarks,index);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.menu_title_imageView:
                finish();
                break;
            case R.id.buy_card_recode_details_btOk:
                finish();
                break;
            case R.id.buy_card_recode_details_btPrint:
