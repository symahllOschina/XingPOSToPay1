package com.wanding.xingpos.date.picker;
...
//        mPaint.setColor(context.getResources().getColor(R.color.color_gold));
        //第二个paint
...
//        mPaint.setColor(context.getResources().getColor(R.color.color_text_unselected));
    }
