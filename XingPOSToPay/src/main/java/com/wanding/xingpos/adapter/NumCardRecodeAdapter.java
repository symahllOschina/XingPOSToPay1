...
public class NumCardRecodeAdapter extends BaseAdapter {

    private Context context;
    private List<NumCardRecodeDetail> list;
    private LayoutInflater inflater;

    public NumCardRecodeAdapter(Context context, List<NumCardRecodeDetail> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvName.setText(list.get(position).getCard_name());
