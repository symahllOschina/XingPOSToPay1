...
import com.wanding.xingpos.activity.CouponsRecodeDetailActivity;
import com.wanding.xingpos.activity.DepositRecodeDetailActivity;
import com.wanding.xingpos.adapter.CouponsRecodeAdapter;
import com.wanding.xingpos.bean.CardVerificaRecodeReqData;
import com.wanding.xingpos.bean.CouponsRecodeResData;
...
public class CouponsRecodeFragment extends BaseFragment implements XListView.IXListViewListener,AdapterView.OnItemClickListener{
    ...
    private List<CouponsRecodeDetail> list = new ArrayList<CouponsRecodeDetail>();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new CouponsRecodeAdapter(activity,list);
    ...
    public void getRecodeList(final int pageNum,final int pageCount){
        ...
        final String url = NitConfig.couponsRecodeUrl;
        Log.e(TAG,"查询优惠券核销记录："+url);
        new Thread(){
            @Override
            public void run() {
                try {
        ...
        try {
            ...
            if("000000".equals(code)){
                ...
                if("000000".equals(subCode)){
                    ...
                    java.lang.reflect.Type type = new TypeToken<CouponsRecodeResData>() {}.getType();
                    CouponsRecodeResData couponsRecodeResData = gjson.fromJson(dataJson, type);
                    //获取总条数
                    orderListTotalCount = couponsRecodeResData.getTotal();
                    Log.e("总条数：", orderListTotalCount+"");
                    List<CouponsRecodeDetail> recodeList = new ArrayList<CouponsRecodeDetail>();
                    //获取的list
                    recodeList = couponsRecodeResData.getCouponList();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        CouponsRecodeDetail order = list.get(position - 1);
        Intent intent = new Intent();
        intent.setClass(activity,CouponsRecodeDetailActivity.class);
